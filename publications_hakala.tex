...
\noindent {\bf PUBLICATIONS} \hfill 21.9.2017\\
...
\item\emp{\bf {** Isotope quantum effects in the electron momentum density of water}},\\ K. Nyg\aa rd, M. Hakala, T. Pylkk{\"a}nen, S. Mannine, T. Buslaps, M. Itou, 
...
\item\emp{ {Multi-intermediate-band character of Ti-substituted CuGaS2: 
...
\item\emp{{{\bf ** Intra- and intermolecular effects on the Compton profile of the ionic liquid 1,3-dimet\-hylimidazolium chloride}}},\\ 
...
\item\emp{{ \bf{** First-principles analysis of the intermediate band in CuGa(1-x)FexS2}}},\\
...
\item\emp{{First principles modelling of perovskite solar cells based on TiO$_2$ and Al$_2$O$_3$: Stability and Interfacial Electronic Structure}},\\
...
\item\emp{{\bf{** Hydrogen adsorption on MoS2-surfaces: a DFT study on preferential sites and the effect of sulfur and hydrogen coverage}}},\\
